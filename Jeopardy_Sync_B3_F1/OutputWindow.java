...
public class OutputWindow
{
    ...
    public static final int SCOREBOARD_PANEL_HEIGHT = 200;
    // GUI components.
    ...
    private JPanel createJeopardyPanel()
    {
        ...
        for (int category = 0; category < CATEGORY_SIZE; category++)
        {
            ...
            jeopardyPanel_label[category] = new JLabel(FileIO.getCategory(category), JLabel.CENTER);
            ...
            jeopardyPanel_label[category].setForeground(JEOPARDY_PANEL_LABEL_COLOR);
            // Changes font.
