...
public class FileIO
{
    ...
    private static final String categoryFileName = "Data/caegories.data";
    ...
    private static final String DEFAULT_LOCATION = "Data//categories.data";
    // instance fields
    // arrays
    ...
    public static void getData(String categoryFileLocation)
    {
        ...
        // Set values.
        category_count = categoryNumber;
        answer_count = answerNumber;
