...
public class OutputWindow
{
    ...
    public static final int ANSWER_PANEL_WIDTH = 150 * FileIO.getCategoryNumber();
    ...
    public OutputWindow()
    {
        answer_count = FileIO.getQuestionNumber();
        question_count = FileIO.getAnswerNumber();
        category_size = FileIO.getCategoryNumber();
        player_count = Jeopardy.PLAYER_COUNT;
        createFrame(question_count,category_size);
     ...
     * 
     * @param the number of questions.
     */
    public void setQuestionCount(int questions)
    {
        question_count = questions;
    } // end of setQuestionCount(int questions)
     ...
     */
    public void setAnswerCount(int answers)
    {
        answer_count = answers;
    } // end of setAnswerCount(int answers)
    ...
    } // end of setPlayerCount(int players)
    ...
    /**
     * Destroys and rebuilds a jeopardy panel according to default parameters.
     */
    public void reloadJeopardy()
    {
        // Remove from frame.
        centerPanel.remove(jeopardyPanel);

        // Rebuild new frame.
        jeopardyPanel = createJeopardyPanel(question_count,category_size);
    ...
    public void reloadScore(int players)
    {
        ...
        Jeopardy.reloadPlayerData(players);
    ...
    private JPanel createJeopardyPanel()
    {
        ...
        jeopardyPanel_questionColumnPanel = new JPanel[FileIO.getCategoryNumber()];

        // Button Listener
        JeopardyPanelButtonListener buttonListener = new JeopardyPanelButtonListener();

        // Create all the questions.
        for (int category = 0; category < FileIO.getCategoryNumber(); category++)
        {
            ...
            for (int question = 0; question < FileIO.getQuestionNumber(); question++)
            {
    ...
    public JPanel createScoreboardPanel()
    {
        ...
        for (int playerIndex = 0; playerIndex < Jeopardy.player_count; playerIndex++)
        {
            // Ensure no array index out of bounds exception.
            try
            {
            ...
            {
                // Tries again by reloading the player data again.
                Jeopardy.reloadPlayerData(Jeopardy.player_count);
    ...
    private class ControlPanelButtonListener implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent event)
        {
            ...
            else if(source == controlPanel_resetButton)
            {
                ...
                {
                    // Reset Data.
                    Jeopardy.reloadPlayerData(player_count);
                    updateScore();
