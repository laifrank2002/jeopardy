...
public class FileIO
{
     ...
     */
    public static void getData(int categoryNumber, int answerNumber, int questionNumber, String fileLocation)
    {
    ...
    } // end of getData(int categoryNumber, int answerNumber, int questionNumber, String fileLocation)
    ...
    /**
     * Imports and stores the data of this jeopardy game from a certain file.
     * 
     * @param file the File that contains the Jeopardy Data.
     */
    public static void getData(File category)
    {
        
        
    } // end of method getData(File category)
    /* private methods */
